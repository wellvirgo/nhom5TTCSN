                                                ...
                                                <div class="row">
                                                    <div class="mb-3">
                                                        ...
                                                        <form:input type="text" class="form-control" id="diaChi"
                                                            name="diaChi" path="diaChi" required="required" />
                                                    </div>
                                                </div>
