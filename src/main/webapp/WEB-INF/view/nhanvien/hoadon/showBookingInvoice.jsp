                                                ...
                                                <div class="card col-6">
                                                    ...
                                                    <ul class="list-group list-group-flush">
                                                        ...
                                                        <li class="list-group-item">
                                                            Phòng: ${hoaDon.datPhong.phong.tenPhong}
                                                            (${hoaDon.datPhong.phong.loaiPhong})
                                                        </li>
                                                        <li class="list-group-item">
                                                            Giá phòng:
                                                            <fmt:formatNumber value="${hoaDon.datPhong.phong.giaPhong} "
                                                                type="number" />
                                                            VND
                                                        </li>
                                                        <li class="list-group-item">Ngày nhận:
                                                            ${hoaDon.datPhong.ngayNhan}
                                                        </li>
                                                        <li class="list-group-item">Ngày trả:
                                                            ${hoaDon.datPhong.ngayTra}
                                                        </li>
